\ Article: 6690 of comp.lang.forth
\ Newsgroups: comp.lang.forth
\ Path: email!news.univie.ac.at!paladin.american.edu!europa.eng.gtefsd.com!darwin.sura.net!aplcen.apl.jhu.edu!netnews!john
\ From: john@netnews.jhuapl.edu (John Hayes)
\ Subject: Testing CORE Words (coretest.fr)
\ Message-ID: <C860DM.IJ9@netnews.jhuapl.edu>
\ Organization: Applied Physics Laboratory of Johns Hopkins University
\ Date: Sat, 5 Jun 1993 20:17:46 GMT
\ Lines: 959
...
\ ------------------------------------------------------------------------
\ commented out to eliminate interactiveness of make test - anton
